...
from startrek_sdk.utility import register

# Load features
from startrek_sdk.feature.base_feature import StarTrekBaseFeature
from startrek_sdk.features import _has_feature, _make_feature
...
class StarTrekSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = StarTrekUtility()
        self._utility = utility

        from startrek_sdk.config import shared_config
    ...
    def get_utility(self):
        return StarTrekUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("StarTrekSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from startrek_sdk.entity.character_entity import CharacterEntity
    ...
    def Episode(self, data=None) -> "EpisodeEntity":
        ...
        from startrek_sdk.entity.episode_entity import EpisodeEntity
    ...
    def Spacecraft(self, data=None) -> "SpacecraftEntity":
        ...
        from startrek_sdk.entity.spacecraft_entity import SpacecraftEntity
    ...
    def Species(self, data=None) -> "SpeciesEntity":
        ...
        from startrek_sdk.entity.species_entity import SpeciesEntity
