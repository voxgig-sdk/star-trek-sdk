...
from startrek_sdk.core.control import StarTrekControl
...
from startrek_sdk.core.helpers import get_ctx_prop, to_map
...
class StarTrekContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, StarTrekResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, StarTrekResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return StarTrekError(code, msg, self)
