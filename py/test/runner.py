...
class StarTrekTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StarTrekTestRunner.getenv("STARTREK_TEST_LIVE")
        override = StarTrekTestRunner.getenv("STARTREK_TEST_OVERRIDE")
        ...
        explain = StarTrekTestRunner.getenv("STARTREK_TEST_EXPLAIN")
