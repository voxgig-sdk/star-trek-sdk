...
class StarTrekTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StarTrekTestRunner.getenv("STAR_TREK_TEST_LIVE")
        override = StarTrekTestRunner.getenv("STAR_TREK_TEST_OVERRIDE")
        ...
        explain = StarTrekTestRunner.getenv("STAR_TREK_TEST_EXPLAIN")
