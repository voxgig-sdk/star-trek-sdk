# StarTrek SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions StarTrekSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both StarTrekSDK(...) and StarTrekSDK.test(...) become
#      StarTrekSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "startrek_sdk"
_SDK_CLASS = "StarTrekSDK"
