...
Results: Successful response with character search results.
...
Results: Successful response with episode search results.
...
Results: Successful response with spacecraft search results.
...
Results: Successful response with species search results.
...
| --- | --- | --- | --- |
| Character | `list` | `GET /character/search` | See reference |
| Episode | `list` | `GET /episode/search` | See reference |
| Spacecraft | `list` | `GET /spacecraft/search` | See reference |
| Species | `list` | `GET /species/search` | See reference |

## Connect to the API

- Production API Server: `https://stapi.co/api/v1/rest`
...
- `star-trek_list`: List records for an entity. Supported entities: `character`, `episode`, `spacecraft`, `species`.
- `star-trek_load`: Load one record for an entity. No active entity supports this operation.
