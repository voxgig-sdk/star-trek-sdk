...
func registerSDKWords(r *eng.Registry, client *sdk.StarTrekSDK) {
...
func runOp(client *sdk.StarTrekSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
