...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/star-trek` | `npm install @voxgig-sdk/star-trek` |
| Python | `voxgig-sdk-star-trek` | `pip install voxgig-sdk-star-trek` |
| PHP | `voxgig-sdk/star-trek` | `composer require voxgig-sdk/star-trek` |
| Golang | `github.com/voxgig-sdk/star-trek-sdk/go` | `go get github.com/voxgig-sdk/star-trek-sdk/go` |
| Ruby | `voxgig-sdk-star-trek` | `gem install voxgig-sdk-star-trek` |
| Lua | `voxgig-sdk-star-trek` | `luarocks install voxgig-sdk-star-trek` |
