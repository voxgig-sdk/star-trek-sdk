...
STAPI is the first public REST API dedicated to all things Star Trek.

Learn more about Star Trek API at [stapi.co](https://stapi.co).
...
This SDK exposes the API as a small set of **semantic entities** — Character, Episode, Spacecraft and Species — that you
