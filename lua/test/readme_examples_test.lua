...
local SDK_MODULE = "star-trek_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["character"] = { ["test01"] = { id = "test01" } }, ["episode"] = { ["test01"] = { id = "test01" } }, ["spacecraft"] = { ["test01"] = { id = "test01" } }, ["species"] = { ["test01"] = { id = "test01" } } } }'
