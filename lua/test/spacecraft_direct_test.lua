...
describe("SpacecraftDirect", function()
  it("should direct-list-spacecraft", function()
    local setup = spacecraft_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-spacecraft", setup.live and "live" or "unit")
...
function spacecraft_direct_setup(mockres)
