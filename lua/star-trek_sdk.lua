...
local StarTrekSDK = {}
StarTrekSDK.__index = StarTrekSDK
...
StarTrekSDK._make_feature = _make_feature


function StarTrekSDK.new(options)
  local self = setmetatable({}, StarTrekSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function StarTrekSDK:options_map()
...
function StarTrekSDK:get_utility()
  return Utility.copy(self._utility)
end


function StarTrekSDK:get_root_ctx()
  return self._rootctx
end


function StarTrekSDK:prepare(fetchargs)
...
function StarTrekSDK:direct(fetchargs)
...
-- by passing it.
function StarTrekSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function StarTrekSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "StarTrekSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function StarTrekSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = StarTrekSDK.new(sdkopts)
  sdk.mode = "test"
