...
function envOverride(m) {
    if ('TRUE' === process.env.STAR_TREK_TEST_LIVE ||
        'TRUE' === process.env.STAR_TREK_TEST_OVERRIDE) {
    ...
    m.STAR_TREK_TEST_EXPLAIN = process.env.STAR_TREK_TEST_EXPLAIN || m.STAR_TREK_TEST_EXPLAIN;
    return m;
}
