...
(0, node_test_1.describe)('SpacecraftDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-spacecraft', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-spacecraft', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.STAR_TREK_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'STAR_TREK_TEST_SPACECRAFT_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.StarTrekSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['STAR_TREK_TEST_SPACECRAFT_ENTID'];
    ...
    const client = new __1.StarTrekSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=SpacecraftDirect.test.js.map