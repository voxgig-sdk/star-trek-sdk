...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = StarTrekOmni.make_runner(TEST_JSON_FILE, StarTrekSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : StarTrekOmni.errify(err)
    end
