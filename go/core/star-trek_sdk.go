...
func (sdk *StarTrekSDK) OptionsMap() map[string]any {
...
func (sdk *StarTrekSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *StarTrekSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *StarTrekSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *StarTrekSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *StarTrekSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *StarTrekSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("StarTrekSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *StarTrekSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *StarTrekSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("StarTrekSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
