...
func TestSpeciesEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set STARTREK_TEST_SPECIES_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func speciesBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("STARTREK_TEST_SPECIES_ENTID")
