...
const testSeed = `map[string]any{"entity": map[string]any{"character": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "episode": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "spacecraft": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "species": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
