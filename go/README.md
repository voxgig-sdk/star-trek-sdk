...
The Golang SDK for the StarTrek API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/star-trek-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/star-trek-sdk=../path/to/github.com/voxgig-sdk/star-trek-sdk
```
...
```
github.com/voxgig-sdk/star-trek-sdk/
...
The root package (`github.com/voxgig-sdk/star-trek-sdk`) re-exports everything needed
