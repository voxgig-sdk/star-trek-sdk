...
class StarTrekRbacFeature extends StarTrekBaseFeature
{
    ...
    private function _required(StarTrekContext $ctx): ?string
    {
    ...
    private function _reject(StarTrekContext $ctx, string $required): void
    {
    ...
    private function _track(StarTrekContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
