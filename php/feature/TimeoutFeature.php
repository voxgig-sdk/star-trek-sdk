...
class StarTrekTimeoutFeature extends StarTrekBaseFeature
{
    ...
    private function _with_timeout(StarTrekContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(StarTrekContext $_ctx, float $ms): void
    {
        $client = $this->client;
