...
// StarTrek SDK streaming feature
...
class StarTrekStreamingFeature extends StarTrekBaseFeature
{
    ...
    private function _iterate(StarTrekResult $result): \Generator
    {
    ...
    private function _streamable(StarTrekContext $ctx): bool
    {
