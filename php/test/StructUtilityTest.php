...
// StarTrek SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = StarTrekOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(StarTrekOmni::structfix($now, Struct::undef()))
                        !== json_encode(StarTrekOmni::structfix($val, Struct::undef()))) {
