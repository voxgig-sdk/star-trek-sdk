...
// StarTrek SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (StarTrekSDK::test)
...
{
    private const SDK_CLASS = 'StarTrekSDK';
    ...
    private const SDK_BASE = 'startrek_sdk';
