...
The PHP SDK for the StarTrek API. Provides an entity-oriented interface using PHP conventions.
...
[$result, $err] = $client->StarTrek(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── startrek_sdk.php          -- Main SDK class
...
The main class (`startrek_sdk.php`) exports the SDK class
