...
|---|---|---|
| `ts/` | @voxgig-sdk/star-trek-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/star-trek-sdk \
      --repository voxgig-sdk/star-trek-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/star-trek-sdk` shows it, and
`npm trust revoke @voxgig-sdk/star-trek-sdk --id=<id>` removes it.
