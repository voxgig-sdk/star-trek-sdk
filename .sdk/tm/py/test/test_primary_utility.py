...
from projectname_sdk import StarTrekSDK
from projectname_sdk.core.spec import StarTrekSpec
from projectname_sdk.core.result import StarTrekResult
from projectname_sdk.core.response import StarTrekResponse
from projectname_sdk.core.operation import StarTrekOperation
from projectname_sdk.core.error import StarTrekError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import StarTrekBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = StarTrekSDK.test(None, None)
        ...
        class TestInitFeature(StarTrekBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(StarTrekBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = StarTrekSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = StarTrekSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = StarTrekSDK.test(None, setup_opts)
