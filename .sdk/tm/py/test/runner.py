...
class StarTrekTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StarTrekTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = StarTrekTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = StarTrekTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
