...
class StarTrekGraphql
{
    ...
    // equivalent.
    public static function body(StarTrekContext $ctx): mixed
    {
    ...
    public static function errors(StarTrekContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
