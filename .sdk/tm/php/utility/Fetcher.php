...
// StarTrek SDK utility: fetcher

class StarTrekFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; StarTrekSDK/1.0)';
    ...
    public static function call(StarTrekContext $ctx, string $fullurl, array $fetchdef): array
    {
