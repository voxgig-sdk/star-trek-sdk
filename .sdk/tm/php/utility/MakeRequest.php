...
// StarTrek SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class StarTrekMakeRequest
{
    public static function call(StarTrekContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new StarTrekResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new StarTrekResponse($fetched);
        } else {
