...
// StarTrek SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class StarTrekTestFeature extends StarTrekBaseFeature
{
    ...
    public function init(StarTrekContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (StarTrekContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (StarTrekContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(StarTrekContext $ctx, $op, $args): array
    {
