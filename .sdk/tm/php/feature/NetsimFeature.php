...
class StarTrekNetsimFeature extends StarTrekBaseFeature
{
    ...
    private function _simulate(StarTrekContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(StarTrekContext $ctx, array $applied): void
    {
        $client = $this->client;
