...
// StarTrek SDK clienttrack feature
...
class StarTrekClienttrackFeature extends StarTrekBaseFeature
{
    ...
    public function PostConstruct(StarTrekContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'StarTrek-SDK';
