...
class StarTrekProxyFeature extends StarTrekBaseFeature
{
    ...
    public function init(StarTrekContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (StarTrekContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
