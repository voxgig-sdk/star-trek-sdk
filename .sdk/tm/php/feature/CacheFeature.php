...
class StarTrekCacheFeature extends StarTrekBaseFeature
{
    ...
    private function _through(StarTrekContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
