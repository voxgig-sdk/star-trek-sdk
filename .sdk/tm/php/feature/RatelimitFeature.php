...
// StarTrek SDK ratelimit feature
...
class StarTrekRatelimitFeature extends StarTrekBaseFeature
{
    ...
    private function _acquire(StarTrekContext $ctx): void
    {
    ...
    private function _track(StarTrekContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
