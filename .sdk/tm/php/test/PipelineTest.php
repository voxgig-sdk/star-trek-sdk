...
{
    private static function utility(): StarTrekUtility
    {
        return new StarTrekUtility();
    }
    ...
    private static function ctx(array $over = []): StarTrekContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new StarTrekContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new StarTrekOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof StarTrekError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new StarTrekOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = StarTrekMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new StarTrekOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = StarTrekMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new StarTrekOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = StarTrekMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new StarTrekSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = StarTrekMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new StarTrekResponse([]),
            'result' => new StarTrekResult([]),
        ]);
        [, $err] = StarTrekMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new StarTrekSpec([]),
            'response' => null,
            'result' => new StarTrekResult([]),
        ]);
        [, $err] = StarTrekMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new StarTrekSpec(['step' => 's']),
            'response' => new StarTrekResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new StarTrekResult([]),
        ]);
        [, $err] = StarTrekMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new StarTrekSpec(['step' => 's']),
            'response' => new StarTrekResponse(self::resp(200, ['v' => 1])),
            'result' => new StarTrekResult([]),
        ]);
        [, $err] = StarTrekMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new StarTrekSpec(['step' => 's']),
            'response' => new StarTrekResponse(self::resp(200, ['v' => 2])),
            'result' => new StarTrekResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        StarTrekMakeResponse::call($ctx);
    ...
    {
        $preset = new StarTrekResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new StarTrekSpec([]),
            'response' => new StarTrekResponse([]),
            'result' => new StarTrekResult([]),
        ...
        [$got, $err] = StarTrekMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new StarTrekResult([])]);
        [, $err] = StarTrekMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new StarTrekSpec([]), 'result' => null]);
        [, $err] = StarTrekMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new StarTrekSpec(['step' => 's']),
            'result' => new StarTrekResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new StarTrekOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = StarTrekMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new StarTrekSpec(['step' => 's']),
            'result' => new StarTrekResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new StarTrekOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = StarTrekMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new StarTrekResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new StarTrekSpec([]),
            'result' => new StarTrekResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = StarTrekMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = StarTrekMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new StarTrekError('boom', 'boom');
        $utility->fetcher = function (StarTrekContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new StarTrekSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = StarTrekMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (StarTrekContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = StarTrekMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(StarTrekResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (StarTrekContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new StarTrekSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = StarTrekMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new StarTrekResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new StarTrekSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = StarTrekMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = StarTrekMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = StarTrekMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new StarTrekResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, StarTrekDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new StarTrekResult(['ok' => false])]);
        $this->expectException(StarTrekError::class);
        StarTrekDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new StarTrekResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', StarTrekMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        StarTrekMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new StarTrekBaseFeature();
        $b = new StarTrekBaseFeature();
        StarTrekFeatureAdd::call($ctx, $a);
        StarTrekFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): StarTrekBaseFeature
    {
        $f = new StarTrekBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        StarTrekFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): StarTrekContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new StarTrekSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = StarTrekPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new StarTrekResponse(['headers' => null]),
            'result' => new StarTrekResult([]),
        ]);
        StarTrekResultHeaders::call($ctx);
