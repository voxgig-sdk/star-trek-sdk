...
type Args struct {
	Entity string         `json:"entity" jsonschema:"character | episode | spacecraft | species"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.StarTrekSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "star-trek_list",
		Description: "List records from StarTrek. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "star-trek_load",
		Description: "Load a single record from StarTrek. " +
...
func runOp(client *sdk.StarTrekSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.StarTrekSDK, name string) (sdk.StarTrekEntity, error) {
	...
	case "spacecraft":
		return client.Spacecraft(nil), nil
	case "species":
